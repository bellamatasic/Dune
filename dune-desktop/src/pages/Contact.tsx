...
const Contact: React.FC = () => {
  return (
    ...
    <section id="contact" className="w-full min-h-[600px] mx-auto py-32 px-4 bg-black relative flex flex-col items-center justify-center overflow-hidden">
      {/* Ghost DUNE Text */}
      ...
      <div className="flex flex-col items-center justify-center flex-1 mt-64">
        ...
        <div className="text-center mb-24">
          <span className="text-white text-[8rem] font-extralight font-['Oswald']">get in </span>
          <span className="text-white text-[8rem] font-bold font-['Oswald']">touch</span>
        </div>
      ...
      {/* Copyright */}
      <div className="mb-4 text-center text-white text-base font-extralight font-['Inter']">
