...
const TitleSection: React.FC = () => {
  return (
    <section className="relative w-full h-screen bg-gradient-to-b from-fuchsia-600/50 via-purple-500/70 to-white overflow-hidden flex items-center justify-center">
